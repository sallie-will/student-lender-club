...
describe InvestmentsController do
  ...
  describe "GET new" do
    it "assigns a new investment as @investment" do
      ...
      assigns(:investment).should be_a_new(Investment)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved investment as @investment" do
        ...
        post :create, {:investment => { "amount" => "invalid value" }}, valid_session
        assigns(:investment).should be_a_new(Investment)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested investment" do
        investment = Investment.create! valid_attributes
        # Assuming there are no other investments in the database, this
        # specifies that the Investment created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Investment.any_instance.should_receive(:update).with({ "amount" => "1.5" })
        put :update, {:id => investment.to_param, :investment => { "amount" => "1.5" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the investment as @investment" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Investment.any_instance.stub(:save).and_return(false)
        put :update, {:id => investment.to_param, :investment => { "amount" => "invalid value" }}, valid_session
        assigns(:investment).should eq(investment)
      end
